...
const Hero = () => {
  return (
    <Container>
      <div className="mt-5 p-5 flex flex-col items-center gap-5 md:flex-row-reverse md:justify-end">
        <div className="">
          <Image src="/profile.JPG" alt="profile" width={500} height={500} className="rounded-xl" />
        </div>
        <div className="flex flex-col m-5 p-5 md:w-[60vh] ">
          ...
          <p className="text-gray-900 dark:text-gray-400 md:text-lg">
